 ...
 * 404 Section
 * 
 * slug: cafe-coffee-blocks/404-page
 * title: 404 Page
 * categories: cafe-coffee-blocks
 */

return array(
    'title'      =>__( '404 Page', 'cafe-coffee-blocks' ),
    ...
    'content'    => '<!-- wp:group {"tagName":"main","className":"wp-block-group alignfull","style":{"spacing":{"padding":{"top":"60px","bottom":"60px"}}},"backgroundColor":"background","layout":{"type":"constrained"}} -->
            ...
            <!-- wp:search {"label":"Search","showLabel":false,"width":75,"widthUnit":"%","buttonText":"Search","align":"center","style":{"color":{"background":"#cb3a1a"}}} /--></main>
            <!-- /wp:group -->',
);